class Item:
    ...
    def __init__(self, name, description, value, stackable = True, quantity = 1):
        self.name = name
...
class Equipment(Item):
    ...
    def __init__(self, name, description, equipment_type, value, durability_value):
        super().__init__(name, description, value)
...
armor = Equipment("броня", "дает 50 брони", "нагрудник", 250, 50)
